            ...
            @foreach($sliders as $slider)
                <li>
                    <div class="slide-holder"
                         style="background:  url('{{ asset(env('THEME')) }}/images/{{ $slider->img }}') no-repeat center center" style="height:483px;">b
                ...
                <div id="yit-widget-area" class="group">
                    <div class="yit-widget-content inner group">
                        <div class="widget-first yit-widget widget col1_4 one-fourth col widget-icon-text group">
                            <img class="icon-img" src=" url('{{ asset(env('THEME')) }}/images/icons/cloud.jpg" alt=""/>
                            <h3>Great Design</h3>
                        ...
                        <div class="yit-widget widget col1_4 one-fourth col widget-last-post group">
                            <img class="icon-img" src=" url('{{ asset(env('THEME')) }}/images/icons/blog1.png" alt=""/>
                            <div>
                        ...
                        <div class="widget-last yit-widget widget col1_4 one-fourth col yit_text_quote">
                            <blockquote class="text-quote-quote">“Anyone who has never made a mistake has never tried
                                anything new.”
                            </blockquote>
