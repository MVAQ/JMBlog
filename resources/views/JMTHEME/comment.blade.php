@foreach($items as $item)
    <li id="li-comment-{{ $item->id }}" class="comment even {{ ($item->user_id == $mspost->user_id)? 'bypostauthor odd': '' }}">
        <div id="comment-{{ $item->id }}" class="comment-container">
            ...
            <div class="comment-meta commentmetadata">
                ...
                <div class="reply group">
                    <a class="comment-reply-link" href="#respond" onclick="return addComment.moveForm(&quot;comment-{{ $item->id }}&quot;, &quot;{{ $item->id }}&quot;, &quot;respond&quot;, &quot;{{ $item->mspost->id }}&quot;)">Reply</a>
                </div>
                <!-- .reply -->
            </div>
